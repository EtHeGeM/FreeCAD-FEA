...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{freecad_screenshots/01_model_axometric.png}
...
\centering
\includegraphics[width=\textwidth]{freecad_screenshots/02_model_front.png}
\centering\small Front view
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{freecad_screenshots/03_model_top.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{freecad_screenshots/04_corrected_von_mises.png}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{freecad_screenshots/05_corrected_principal_sigma1.png}
\centering\small Principal stress \(\sigma_1\)
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{freecad_screenshots/06_corrected_principal_sigma3.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{freecad_screenshots/07_corrected_displacement.png}
...
\midrule
\endhead
\texttt{MECT2222\_Project.pdf} & Project instructions and rubric \\
\texttt{MECT2222\_Project Assignment Sheet.pdf} & Assignment sheet \\
\texttt{shaft\_6061\_fem.py} & FreeCAD FEM automation script \\
\texttt{shaft\_6061\_t6\_fem.FCStd} & Generated FreeCAD model \\
\texttt{shaft\_6061\_fem\_output/Gmsh\_Mesh\_3mm\_8mm.inp} & Original CalculiX input file \\
\texttt{shaft\_6061\_fem\_output/Gmsh\_Mesh\_3mm\_8mm.dat} & Original reaction-force output \\
\texttt{shaft\_6061\_fem\_output/Gmsh\_Mesh\_3mm\_8mm.frd} & Original FEA result file \\
\texttt{shaft\_6061\_fem\_output/Gmsh\_Mesh\_3mm\_8mm\_corrected.inp} & Corrected CalculiX input file \\
\texttt{shaft\_6061\_fem\_output/Gmsh\_Mesh\_3mm\_8mm\_corrected.dat} & Corrected reaction-force output \\
\texttt{shaft\_6061\_fem\_output/Gmsh\_Mesh\_3mm\_8mm\_corrected.frd} & Corrected FEA result file \\
\texttt{freecad\_screenshots/*.png} & FreeCAD screenshots and corrected result plots \\
\bottomrule
\end{longtable}
